        ...
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Télegram</a>
                        </li>
                        <li class="mb-4">
                ...
                <br/>
                <div>
                    <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Politique & Confidentialité</h3>
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li class="mb-4">
            ...
            <div class="text-center">
                <a href="#"
                    ...
                    <img src="../assets/images/eyes.jpg" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                   HORUS
                </a>
